  ...
  return (
    <div className="group relative w-full">
      <motion.button
        ...
        className={`relative w-full p-3 rounded-xl border-2 text-center transition-colors ${
          !player.isAlive
      ...
      {/* Tooltip */}
      {tooltip && (
        <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-1 hidden group-hover:block z-50 w-48 pointer-events-none">
          <div className="bg-bg-secondary border border-accent-purple/30 rounded-lg px-2 py-1.5 text-[10px] text-text-secondary shadow-lg backdrop-blur-sm">
            {tooltip}
          </div>
